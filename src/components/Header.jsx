        ...
        <header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-gray-800 text-sm py-4 dark:bg-white" style={{backgroundColor:'#1f2937'}}>
            <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                ...
                <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                    <Link to="/Login" class="text-2xl font-medium text-blue-500">Login</Link>
                    <Link to="/Register" class="text-2xl font-medium text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400" >Register</Link>
                    <a class="text-2xl font-medium text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400" href="#">Work</a>
                    <a class="text-2xl font-medium text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400" href="#">Blog</a>
                </div>
                </div>
            </nav>
        </header>
