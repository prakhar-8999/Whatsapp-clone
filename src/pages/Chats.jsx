...
import Messageloader from '../static/Messageloader';
                                        ...
                                        msgloading ? <Messageloader /> :
                                            ...
                                            allmessages.map((msg, index) => (
                                                <>
                                                    ...
                                                    {/* <div style={{float:msg.reciever_id === perticularcontact.id ? 'right':'left'}} key={index}>
                                        <p>{msg.message}</p>
                                    </div><br /> */}
                                                </>
                                            ))
