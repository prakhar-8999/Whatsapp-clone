                    ...
                    <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
                        ...
                        <div class="w-full block flex-grow lg:flex lg:items-end lg:w-auto">
                            <div class="text-sm items-end lg:flex-grow">
                                ...
                                <div class="hs-dropdown relative" data-hs-dropdown-placement="left-top">
                                ...
                                <div id="new-contact" class="hs-offcanvas hs-offcanvas-open:translate-x-0 -translate-x-full fixed top-0 left-0 transition-all duration-300 transform h-full max-w-xs w-full z-[60] bg-white border-r dark:bg-gray-800 dark:border-gray-700" tabindex="-1">
                                ...
                                <div id="status" class="hs-offcanvas hs-offcanvas-open:translate-y-0 -translate-y-full fixed top-0 inset-x-0 transition-all duration-300 transform max-h-40 h-full w-full z-[60] bg-white border-b dark:bg-gray-800 dark:border-gray-700" tabindex="-1">
                                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
                                    <h3 class="font-bold text-gray-800 dark:text-white">
                                    Offcanvas title
                                    </h3>
