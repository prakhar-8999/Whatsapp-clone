        ...
        <div class="bg-white p-16 rounded shadow-2xl w-2/3">
          ...
          <form class="space-y-5">
            ...
            <div>
              ...
              <input type="text" value={name} onChange={(e) => setname(e.target.value)} class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-gray-800" />
            </div>

            <div>
              <label class="block mb-1 font-bold text-gray-500">Email</label>
              <input type="email" value={email} onChange={(e) => setemail(e.target.value)} class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-gray-800" />
            </div>

            <div>
              <label class="block mb-1 font-bold text-gray-500">Phone Number</label>
              <input type="number" value={phone} onChange={(e) => setphone(e.target.value)} class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-gray-800" />
            </div>

            <div>
              <label class="block mb-1 font-bold text-gray-500">Password</label>
              <input type="password" value={password} onChange={(e) => setpassword(e.target.value)} class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-gray-800" />
            </div>
